...
# card1 bbox [397,602]-[594,816]. top-center: x 455-550, y 596-632
$x = 455; $y = 596; $cw = 95; $ch = 36
$scale = 4
...
$g.Dispose()
$bmp.Save('D:\GutGardenBeta\.shots\card1-topcenter.png', [System.Drawing.Imaging.ImageFormat]::Png)
$bmp.Dispose(); $ref.Dispose()
Write-Output 'saved card1-topcenter.png'
