...
await page.evaluate(() => {
  ...
  // Simulate 9 stars: fiber=2, ferment=2, scfa=2, barrier=2, eco=1 → total=9
  const codes = ['fiber_square', 'ferment_workshop', 'scfa_spring', 'barrier_wall', 'eco_station']
  const stars = [2, 2, 2, 2, 1]
...
await sleep(2500)
await page.screenshot({ path: 'D:/GutGardenBeta/scratch/current_classroom_done.png' })
